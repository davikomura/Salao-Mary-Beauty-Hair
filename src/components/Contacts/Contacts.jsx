            ...
            <div className="text-center p-8 bg-black">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 p-4 mb-28">
                    ...
                    <div className="text-left text-white ml-8">
                        ...
                        <p className="text-center md:text-left">425 6th Ave, New York, NY 10046, United States</p>
                    </div>
                    <div className="text-left text-white ml-8">
                        <h2 className="text-center md:text-left text-lg sm:text-xl md:text-2xl lg:text-3xl text-white mb-4">Business Hours</h2>
                        <p className="text-center md:text-left mb-2">Monday – Closed</p>
                        <p className="text-center md:text-left mb-2">Tuesday : 11.00 – 09.00</p>
                        <p className="text-center md:text-left mb-2">Wednesday : 11.00 – 09.00</p>
                        <p className="text-center md:text-left mb-2">Thursday : 11.00 – 09.00</p>
                        <p className="text-center md:text-left mb-2">Friday : 11.00 – 09.00</p>
                        <p className="text-center md:text-left mb-2">Saturday : 11.00 – 09.00</p>
                        <p className="text-center md:text-left">Sunday : 11.00 – 09.00</p>
                    </div>
                </div>
